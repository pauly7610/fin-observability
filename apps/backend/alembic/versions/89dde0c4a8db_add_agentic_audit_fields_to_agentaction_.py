...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_compliance_logs_event_id"),
        "compliance_logs",
        ["event_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_compliance_logs_id"), "compliance_logs", ["id"], unique=False
    )
    op.create_table(
        "system_metrics",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_agent_actions_incident_id"),
        "agent_actions",
        ["incident_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_actions_workflow_id"),
        "agent_actions",
        ["workflow_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_export_metadata_export_type"),
        "export_metadata",
        ["export_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_export_metadata_id"), "export_metadata", ["id"], unique=False
    )
    op.create_table(
        "incidents",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_agent_action_audit_logs_agent_action_id"),
        "agent_action_audit_logs",
        ["agent_action_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_action_audit_logs_id"),
        "agent_action_audit_logs",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_agent_action_audit_logs_id"), table_name="agent_action_audit_logs"
    )
    op.drop_index(
        op.f("ix_agent_action_audit_logs_agent_action_id"),
        table_name="agent_action_audit_logs",
    )
